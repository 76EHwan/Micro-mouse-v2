/**
  ...
  * @brief   This file provides the VL53L4CX ranging sensor component driver
  ******************************************************************************
  * @attention
  *
...
/** @addtogroup VL53L4CX
  ...
  *            VL53L4CX ranging sensor.
  * @{
  */

/** @defgroup VL53L4CX_Private_TypesDefinitions Private Types Definitions
  * @{
  */
...
/**
  * @}
  */
/** @defgroup VL53L4CX_Private_Variables Private Variables
  * @{
  */

VL53L4CX_RANGING_SENSOR_Drv_t VL53L4CX_RANGING_SENSOR_Driver =
{
  VL53L4CX_Init,
  VL53L4CX_DeInit,
  VL53L4CX_ReadID,
  VL53L4CX_GetCapabilities,
  VL53L4CX_ConfigProfile,
  VL53L4CX_ConfigROI,
  VL53L4CX_ConfigIT,
  VL53L4CX_GetDistance,
  VL53L4CX_Start,
  VL53L4CX_Stop,
  VL53L4CX_SetAddress,
  VL53L4CX_GetAddress,
  VL53L4CX_SetPowerMode,
  VL53L4CX_GetPowerMode
};
...
/** @defgroup VL53L4CX_Private_Functions_Prototypes Private Functions Prototypes
  * @{
  */
...
/**
  * @brief Initializes the vl53l4cx context object.
...
/**
  * @brief Read the vl53l4cx device ID.
  * @param pObj    vl53l4cx context object.
...
/**
  * @brief Get the vl53l4cx capabilities.
  * @param pObj    vl53l4cx context object.
...
/**
  * @brief Configure the Region of Interest of the vl53l4cx.
  * @param pObj    vl53l4cx context object.
